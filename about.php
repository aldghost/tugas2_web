...
<head>
    ...
    <title>Tugas2 Aldin - 1402019011</title>
</head>
    ...
    <div class="middle">
        <div class="middle-item">
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="#" id="now">About Me</a>
                <a class="nav-link" href="ask.html">Ask Me!</a>
            </nav>
        </div>
        <div class="middle-item">
            <div class="container">
                ...
                <hr>
                <figure class="figure">
                    <img src="elon.jpg" class="figure-img img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">Lorem ipsum dolor.</figcaption>
                </figure>

                <div class="container">
                    <h3>Hi! I am Aldin Gans</h3>
